...
new class extends Component
{
    ...
    {
        // $this->blogs = Blog::where('type', 1)->orderBy('id', 'desc')->get(['id','cover', 'title', 'type', 'updated_at'])->toArray();
    }
}; ?>

<section class="bg-white dark:bg-gray-900">
    @php
        $blogs_withpage = Blog::where('type', 1)->orderBy('id', 'desc')->paginate(6, ['id','cover', 'title', 'type', 'updated_at']);
    @endphp
